# 🤖 VLA Interview Projects

> 第三周动手实践项目：跑通 VLA 技术栈核心模型的训练-测试流程，建立工程实践感

## 📋 目录

- [项目目标](#项目目标)
- [项目总览](#项目总览)
- [项目 1：CNN 图像分类统一框架](#项目-1cnn-图像分类统一框架)
- [项目 2：目标检测统一框架](#项目-2目标检测统一框架)
- [项目 3：图像分割统一框架](#项目-3图像分割统一框架)
- [项目 4：独立模型项目](#项目-4独立模型项目)
  - [4.1 Swin Transformer](#41-swin-transformer)
  - [4.2 CLIP](#42-clip)
  - [4.3 DINO / DINOv2](#43-dino--dinov2)
  - [4.4 DDPM](#44-ddpm)
  - [4.5 DDIM](#45-ddim)
  - [4.6 MVSNet](#46-mvsnet)
  - [4.7 Mip-NeRF](#47-mip-nerf)
  - [4.8 Mip-Splatting](#48-mip-splatting)
- [项目 5：Diffusion Policy](#项目-5diffusion-policy机械臂抓取)
- [项目 6：ACT](#项目-6act机械臂抓取)
- [项目 7：RL 算法对比](#项目-7rl-算法对比机械臂抓取)
- [项目 8：OpenVLA 微调](#项目-8openvla-微调机械臂抓取)
- [项目 9：Octo 微调](#项目-9octo-微调替代-π0)
- [环境配置](#环境配置)
...
pip install denoising-diffusion-pytorch  # DDPM
pip install octo-model           # Octo
```
...
| 天数 | 项目 | 任务 |
|------|------|------|
| Day 1（周一） | 项目 1 — CNN 分类 | 搭建环境，跑通所有 CNN 模型训练，对比结果 |
| Day 2（周二） | 项目 2 — 目标检测 | 训练 Faster R-CNN、YOLO、DETR，对比 mAP |
| Day 3（周三） | 项目 3 — 图像分割 | 训练 FCN/DeepLab/U-Net/Mask R-CNN，评估 SAM |
| Day 4（周四） | 项目 4（上） | Swin Transformer + CLIP + DINO + DDPM |
| Day 5（周五） | 项目 4（下） | DDIM + MVSNet + Mip-NeRF + Mip-Splatting |
| Day 6（周六） | 项目 5-6 | 搭建 LeRobot，训练 Diffusion Policy 和 ACT |
| Day 7（周日） | 项目 7 | 搭建 robosuite，训练 PPO/SAC/TD3 |
| Day 8-9 | 项目 8-9 | OpenVLA + Octo 微调 |
| Day 10 | 复盘 | 整理笔记，准备面试陈述 |

---

## License

This project is for personal interview preparation.
